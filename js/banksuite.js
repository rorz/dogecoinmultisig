...
$("#bankSuitePay1").click(function(){
	var redeem_script 	= document.getElementById("bankSuitePersonal1Redeem").value;
	var address		= document.getElementById("bankSuitePersonal1").value;
	console.info("Redeem Script to be sent is: " + redeem_script);
	var tt1 = document.location.origin+''+document.location.pathname+'?redeemMultiSig='+address+redeem_script+'#redeemMultiSig' ; 
	console.info("Value is " + tt1);
	window.open(tt1);
        //$("#bankSuitePageURL").val(document.location.origin+''+document.location.pathname+  '?bankSuite='+coin.pubkey+coin2.pubkey+'#bankSuite');
//	window.open("http://dogecoinmultisig.org/multisigtest/#redeemMultiSig");
});

/* user presses one of the 6 'Spend from multisig' buttons */
$("#bankSuitePay2").click(function(){
	var tt1 = "Spending is coming soon (bankSuitePay2)";
	console.info(tt1);
	window.open("http://dogecoinmultisig.org/multisigtest/#redeemMultiSig");
});
...
$("#bankSuitePay3").click(function(){
	var tt1 = "Spending is coming soon (bankSuitePay3)";
	console.info(tt1);
	window.open("http://dogecoinmultisig.org/multisigtest/#redeemMultiSig");
});
...
$("#bankSuitePay4").click(function(){
	var tt1 = "Spending is coming soon (bankSuitePay4)";
	console.info(tt1);
	window.open("http://dogecoinmultisig.org/multisigtest/#redeemMultiSig");
});
...
$("#bankSuitePay5").click(function(){
	var tt1 = "Spending is coming soon (bankSuitePay5)";
	console.info(tt1);
	window.open("http://dogecoinmultisig.org/multisigtest/#redeemMultiSig");
});
...
$("#bankSuitePay6").click(function(){
	var tt1 = "Spending is coming soon (bankSuitePay6)";
	console.info(tt1);
	window.open("http://dogecoinmultisig.org/multisigtest/#redeemMultiSig");
});
...
//				console.info("wb1 = " + work_balance[idx] + " and wb2 = " + data.data.confirmed_balance);
				var ttimer = (250 * parseInt(idx));
				setTimeout(function () {
//					tt2[idx] = "Balance: " + work_balance[idx];
//					document.getElementById("bankSuitePersonal2Balance").innerHTML = data.data.confirmed_balance; 
//					document.getElementById(urlName).innerHTML = data.data.confirmed_balance;
					var el_tempvaro = "Balance: " + work_balance[idx];
					document.getElementById(urlName).innerHTML = el_tempvaro; //display to HTML
					//document.getElementById(urlName).innerHTML = work_balance[idx]; //display to HTML
				}, ttimer);
                        },
